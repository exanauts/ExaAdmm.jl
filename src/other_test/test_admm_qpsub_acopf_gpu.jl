...
env2, mod2 = ExaAdmm.solve_qpsub(case, mod1.Hs, mod1.LH_1h, mod1.RH_1h,
    ...
    initial_beta; outer_iterlim=10000, inner_iterlim=1, scale = 1e-4, obj_scale = 1, rho_pq = 4000.0, rho_va = 4000.0, verbose=1, outer_eps=2*1e-6, onelevel = true, use_gpu = true, gpu_no = 1)
