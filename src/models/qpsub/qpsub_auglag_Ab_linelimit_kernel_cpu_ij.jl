...
function auglag_Ab_linelimit_two_level_alternative_qpsub_ij(
    ...
    # initialization on 
    membuf[5] = 10.0 #initial ρ_1h = ρ_1i = ρ_1j = ρ_1k (let ρ the same for all AL terms)
