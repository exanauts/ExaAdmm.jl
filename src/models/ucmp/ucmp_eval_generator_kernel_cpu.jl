...
function eval_f_generator_continuous_kernel_cpu(
    t::Int, I::Int, x::Array{Float64,1}, param::Array{Float64,2}, scale::Float64,
...
function eval_grad_f_generator_continuous_kernel_cpu(
    t::Int, I::Int, x::Array{Float64,1}, g::Array{Float64,1}, param::Array{Float64,2}, scale::Float64,
    c2::Float64, c1::Float64, c0::Float64, baseMVA::Float64
)
    @inbounds begin
...
function eval_h_generator_continuous_kernel_cpu(
    t::Int, I::Int, x::Array{Float64,1}, mode::Symbol, scale::Float64,
    ...
    @inbounds begin
        nonzeros_all = [(1,1), 
                        ...
                        (12,2), (12,4),
                        (13,2), (13,4),
                        (5,5), (6,6), (10,10),(11,11), (12,12), (13,13)]

        nonzeros_tg1 = [(3,1),(3,3),
                        (4,3), 
                        (5,1), (5,3),
                        (6,1), (6,3), (6,4), 
                        (7,1), (7,3), (7,5), (7,7),
        ...
        if mode == :Structure
            nz = 0
            for (i,j) in vcat(nonzeros_all, nonzeros_tg1)
                nz += 1
                rows[nz] = i
                cols[nz] = j
            end
