function bus_kernel_two_level_alternative(
    baseMVA::Float64, nbus::Int, gen_start::Int, line_start::Int,
    FrStart::Array{Int,1}, FrIdx::Array{Int,1},
    ToStart::Array{Int,1}, ToIdx::Array{Int,1},
    GenStart::Array{Int,1}, GenIdx::Array{Int,1},
    Pd::Array{Float64,1}, Qd::Array{Float64,1},
