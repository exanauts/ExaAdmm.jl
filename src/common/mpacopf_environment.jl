...
mutable struct MultiPeriodModel{T,TD,TI,TM} <: AbstractOPFModel{T,TD,TI,TM}
    ...
    function MultiPeriodModel{T,TD,TI,TM}(env::AdmmEnv{T,TD,TI,TM};
        ...
        mod.models = Vector{Model{T,TD,TI,TM}}(undef, num_periods)
...
mutable struct MultiPeriodModelLoose{T,TD,TI,TM} <: AbstractOPFModel{T,TD,TI,TM}
    info::IterationInformation
    solution::Vector{SolutionRamping{T,TD}} # ramp related solution
    ...
    function MultiPeriodModelLoose{T,TD,TI,TM}(env::AdmmEnv{T,TD,TI,TM};
        start_period=1, end_period=1, ramp_ratio=0.02) where {T,TD<:AbstractArray{T},TI<:AbstractArray{Int},TM<:AbstractArray{T,2}}
