...
CUDA.@profile env, mod = ExaAdmm.solve_acopf(case; rho_pq=3e4, rho_va=3e5, outer_iterlim=20, inner_iterlim=1000, scale=1e-5, tight_factor=0.99, use_gpu=true, obj_scale=2.0)
